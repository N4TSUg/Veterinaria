...
namespace Veterinaria.Migrations
{
    ...
    [Migration("20260717180937_AddControlAntiparasitario")]
    partial class AddControlAntiparasitario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Veterinaria.Models.ControlAntiparasitario", b =>
                {
                    b.Property<int>("IdControlAntiparasitario")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdControlAntiparasitario"));
                    ...
                    b.HasKey("IdControlAntiparasitario");

                    b.HasIndex("IdMascota");

                    b.ToTable("ControlesAntiparasitarios");
                });
            ...
            modelBuilder.Entity("Veterinaria.Models.ControlAntiparasitario", b =>
                {
                    b.HasOne("Veterinaria.Models.Mascota", "Mascota")
                        .WithMany("ControlesAntiparasitarios")
                        .HasForeignKey("IdMascota")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Veterinaria.Models.Mascota", b =>
                {
                    ...
                    b.Navigation("ControlesAntiparasitarios");
