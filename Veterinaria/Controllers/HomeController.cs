    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var proximasCitasList = await _context.Consultas
                ...
                .Where(c => c.FechaProximaCita != null && c.FechaProximaCita >= hoy)
            ...
            var vm = new DashboardVM
            {
                ...
                ProximasCitas = await _context.Consultas.CountAsync(c => c.FechaProximaCita != null && c.FechaProximaCita >= hoy),
